...
export default function NewInspectionPage() {
  ...
  const { data: sites, isLoading: loadingSites } = trpc.inspection.getSites.useQuery();
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-2">
        {[
          ...
          { num: 3, label: "Site", labelAr: "الموقع" },
        ].map((s, i) => (
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>اختر الموقع (اختياري)</CardDescription>
              </div>
          ...
          <CardContent>
            {loadingSites ? (
              ...
              <div className="space-y-3">
                ...
                >
                  <p className="font-medium">No specific site</p>
                  <p className="text-sm text-zinc-400">
                    Start inspection without a registered site
                  </p>
                </button>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-zinc-400">No sites registered yet</p>
                <p className="text-sm text-zinc-500 mt-1">
                  You can still start an inspection without a site
                </p>
              </div>
            )}
